...
return [
    ...
    */
    ...
    'titles' => [
        ...
        'edit-role'                 => 'Editing Role: :role',
        'create-permission'         => 'Create New Permission',
        'edit-permission'           => 'Editing Permission: :permission',
    ...
    'subtitles' => [
        'edit-role'               => 'Make changes to role details.',
        'edit-permission'               => 'Make changes to permission details.',
    ],

    'cards' => [
        'users-count'       => '{0,1} :count user|[2,*] :count users',
        'permissions-count' => '{0,1} :count permission|[2,*] :count permissions',
        'roles-count'       => '{0,1} :count role|[2,*] :count roles',
        'none-count'        => 'None',
        'level'             => 'Level :level',
        'role-card'         => [
            'user-id'                   => 'User Id',
    ...
    'roles-table' => [
        'caption'       => '{0,1} :count role total|[2,*] :count total roles',
        'id'            => 'ID',
        'name'          => 'Name',
        'desc'          => 'Description',
        'level'         => 'Level',
    ...
    'roles-deleted-table' => [
        'caption'       => '{0,1} :count deleted role total|[2,*] :count total deleted roles',
    ],

    'permissions-table' => [
        'caption'       => '{0,1} :count permission total|[2,*] :count total permissions',
        'id'            => 'ID',
        'name'          => 'Name',
        'slug'          => 'Slug',
        'desc'          => 'Description',
    ...
    'permissions-deleted-table' => [
        'caption'       => '{0,1} :count deleted permission total|[2,*] :count total deleted permissions',
    ],
    ...
    'flash-messages' => [
        ...
        'deleteDefaultError' => 'You cannot delete role :role!,  this default role!',
        'canot-edit-role' => 'Cannot edit role :role!, this default role!',
    ],
