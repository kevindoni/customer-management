...
>
    ...
    >
        <div class="pl-3 pr-4">
            <flux:icon icon="{{ $icon }}" variant="solid" class="hidden size-4! group-data-open/disclosure-button:block" />
            <flux:icon icon="{{ $icon }}" class="block size-4! group-data-open/disclosure-button:hidden" />
        </div>
