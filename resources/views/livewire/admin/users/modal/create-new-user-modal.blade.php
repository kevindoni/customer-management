<div>
    @if ($addUserModal)
        <flux:modal class="md:w-120" wire:model="addUserModal" :dismissible="false"
            @close="$dispatch('close-add-user-modal')">
            <div class="space-y-6">
                <div>
                    <flux:heading size="lg">
                        {{ trans('user.title.add-user') }}
                    </flux:heading>
                    <flux:subheading>
                        {{ trans('user.title.add-user-information') }}
                    </flux:subheading>
                </div>
