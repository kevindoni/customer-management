        ...
        <div class="flex flex-col gap-6">
            ...
            <div class="flex flex-col gap-2">
                <flux:heading size="lg" class="underline md:underline-offset-8">
                    Format Standard Pesan Pembatalan Pembayaran
                </flux:heading>
                ...
                <div class="flex md:flex-row flex-col gap-2 mt-6">
                    ...
                    <flux:text>
                        <div
                            class="md:w-128 relative overflow h-96 rounded-xl border border-neutral-200 dark:border-neutral-700 p-6 mt-6">
                            <div>
